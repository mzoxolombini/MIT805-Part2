...
import com.mapreduce.app.BrandAverageSales.CompositeWritable;

public class MapReduce {
		
	
		public static class BrandMapper extends Mapper<Object, Text, Text, CompositeWritable>
		{
		...
		public static class BrandReducer extends Reducer<Text,CompositeWritable,Text,FloatWritable>
		{
			...
			public void reduce(Text key, Iterable<CompositeWritable> values, Context context) throws IOException, InterruptedException
			{
				...
				result.set(total / numberOfBrands);
